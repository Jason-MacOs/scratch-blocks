...
Blockly.Msg.DATA_ADDTOLIST = "将 %1 加到 %2 末尾";
...
Blockly.Msg.DATA_ITEMNUMOFLIST = "%1 在 %2 中的位置";
...
Blockly.Msg.EVENT_WHENKEYPRESSED_LEFT = "左移键";
Blockly.Msg.EVENT_WHENKEYPRESSED_RIGHT = "右移键";
Blockly.Msg.EVENT_WHENKEYPRESSED_DOWN = "下移键";
Blockly.Msg.EVENT_WHENKEYPRESSED_UP = "上移键";
...
Blockly.Msg.LOOKS_SWITCHBACKDROPTO = "将背景设为 %1";
Blockly.Msg.LOOKS_GOTOFRONTBACK = "移到最 %1 ";
Blockly.Msg.LOOKS_GOTOFRONTBACK_FRONT = "上层";
Blockly.Msg.LOOKS_GOTOFRONTBACK_BACK = "下层";
...
Blockly.Msg.LOOKS_SWITCHBACKDROPTOANDWAIT = "将背景切换到 %1 并等待";
...
Blockly.Msg.SENSING_DAYSSINCE2000 = "自2000年到现在的天数";
...
Blockly.Msg.SOUND_CLEAREFFECTS = "清除声音效果";
...
Blockly.Msg.REMOVE_COMMENT = "移除备注";
Blockly.Msg.DELETE_BLOCK = "移除代码块";
Blockly.Msg.DELETE_X_BLOCKS = "移除代码块 %1";
Blockly.Msg.DELETE_ALL_BLOCKS = "移除所有代码块 %1?";
Blockly.Msg.CLEAN_UP = "整理代码块";
Blockly.Msg.HELP = "帮助";
Blockly.Msg.UNDO = "撤销";
Blockly.Msg.REDO = "重做";
Blockly.Msg.EDIT_PROCEDURE = "编辑";
Blockly.Msg.SHOW_PROCEDURE_DEFINITION = "跳转到定义";
...
Blockly.Msg.CHANGE_VALUE_TITLE = "改变数值:";
Blockly.Msg.RENAME_VARIABLE = "重命名列表";
Blockly.Msg.RENAME_VARIABLE_TITLE = "重命名列表 %1 为:";
Blockly.Msg.RENAME_VARIABLE_MODEL_TITLE = "重命名列表";
Blockly.Msg.NEW_VARIABLE = "新建变量";
Blockly.Msg.NEW_VARIABLE_TITLE = "变量名:";
Blockly.Msg.VARIABLE_MODEL_TITLE = "新建变量";
Blockly.Msg.VARIABLE_ALREADY_EXISTS = "变量名 %1 已存在.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE = "变量 %1 在类型 %2 中已存在.";
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION = "确认删除%1处使用变量%2？";
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE = "无法移除变量%1，因为函数%2中已使用.";
Blockly.Msg.DELETE_VARIABLE = "移除列表 %1";
Blockly.Msg.NEW_PROCEDURE = "创建函数";
Blockly.Msg.PROCEDURE_ALREADY_EXISTS = "模组名称 %1 已存在.";
Blockly.Msg.NEW_LIST = "新建列表";
Blockly.Msg.NEW_LIST_TITLE = "列表名称:";
Blockly.Msg.LIST_MODAL_TITLE = "新建列表";
Blockly.Msg.LIST_ALREADY_EXISTSk = "列表名称 %1 已存在.";
Blockly.Msg.RENAME_LIST_TITLE = "重命名列表 %1 为:";
Blockly.Msg.RENAME_LIST_MODAL_TITLE = "重命名列表";
Blockly.Msg.NEW_BROADCAST_MESSAGE = "新建消息";
Blockly.Msg.NEW_BROADCAST_MESSAGE_TITLE = "消息名称:";
Blockly.Msg.BROADCAST_MODAL_TITLE = "新建消息";
Blockly.Msg.DEFAULT_BROADCAST_MESSAGE_NAME = "默认消息";
Blockly.Msg.BOOLEAN = "布尔值";
Blockly.Msg.NUMBER_OR_TEXT = "数字或文本";
Blockly.Msg.LABEL_TEXT = "文本标签";
